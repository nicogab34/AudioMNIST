...
mprof run -o "logs/mprofile_<YYYYMMDDhhmmss>.dat" train_audionet.py -i tf_data/audionet.tfrecords -o models/audionet_conv_size_5 -l tensorboard/audionet2_lr_0.0005_conv_size_5 -b 100 -e 50